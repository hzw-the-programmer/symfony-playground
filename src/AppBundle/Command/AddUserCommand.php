...
class AddUserCommand extends ContainerAwareCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->setDescription('Creates users and stores them in database')
    ...
    {
        if (null !== $this->getArgument('username') &&
            null !== $this->getArgument('password') &&
            null !== $this->getArgument('email')) {
            return;
        }
        ...
        $output->writeln(array(
            ...
            '',
            ' $ php app/console app:add-user username password emial@example.com',
            '',
        ));
